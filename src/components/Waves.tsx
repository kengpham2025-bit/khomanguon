export function BottomWaves() {
  return (
    <div className="wave-bottom" aria-hidden>
      <svg viewBox="0 0 1440 320" style={{ color: "rgba(16, 185, 129, 0.18)" }} preserveAspectRatio="none">
        <path
          fill="currentColor"
          fillOpacity={0.9}
      ...
      <svg viewBox="0 0 1440 320" style={{ color: "rgba(16, 185, 129, 0.1)", bottom: 8, position: "absolute", width: "120%", left: "-10%" }} preserveAspectRatio="none">
        <path
          fill="currentColor"
          fillOpacity={0.7}
